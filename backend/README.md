...
## Project Structure
    ...
    ├── testapiautoteammemb_63032  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_63032`
...
2. Clone this repo and `cd testapiautoteammemb_63032`
